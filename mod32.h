...
//R.K. if you choose to use the slow setting please change in main.c [ulPeriod = SYSCLK / SAMPLERATE;] add +1 to ulPeriod
// #define ENCODERRATE 5000 (rotary encoder)

#define SAMPLERATE BITBOX_SAMPLERATE     
#define BITDEPTH BITBOX_SAMPLE_BITDEPTH 
// #define SOUNDBUFFERSIZE 4096                      // Stereo circular sound buffer 2 * 4096 = 8192 bytes of memory
...
#define ROWS 64
#define SAMPLES 31
#define CHANNELS 6 // changed from 18 to 4 - to 6
